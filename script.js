document.addEventListener('DOMContentLoaded', function () {
  ...
  (function () {
    ...
    function getErrorEl(field) {
      let err = field.parentElement.querySelector('.' + ERROR_CLASS + '-msg');
      if (!err) {
        err = document.createElement('span');
        err.className = ERROR_CLASS + '-msg';
    ...
    function clearError(field) {
      ...
      const err = field.parentElement.querySelector('.' + ERROR_CLASS + '-msg');
    ...
    function getFormFields() {
      return Array.from(form.querySelectorAll('input, textarea, select')).filter(function (f) {
        ...
        .then(function (response) {
          if (response.ok) {
            ...
            successMsg.textContent =
              form.dataset.successMessage || 'Thank you! Your message has been sent successfully.';
          } else {
            throw new Error('Server responded with status ' + response.status);
          }
        })
        .catch(function () {
          let errorMsg = form.querySelector('.form-submit-error');
          if (!errorMsg) {
          ...
          errorMsg.textContent =
            form.dataset.errorMessage || 'Something went wrong. Please try again later.';
        })
        .finally(function () {
          if (submitBtn) {
  ...
  (function () {
    const ANIMATE_CLASS = 'fade-in-ready';
    const VISIBLE_CLASS = 'fade-in-visible';
    const SELECTOR = '.fade-in, [data-animate], .animate-on-scroll';
    ...
    if (!document.getElementById('fade-in-styles')) {
      ...
      style.textContent = [
        ...
        '@media(prefers-reduced-motion:reduce){.' + ANIMATE_CLASS + ',.' + ANIMATE_CLASS + '.' + VISIBLE_CLASS + '{transition:none;transform:none;opacity:1;}}',
      ].join('');
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "אובליגו שירותי ייעוץ לתיירות ופנאי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    (function() {
        ...
        function initContactForm() {
            ...
            try {
                ...
                const payload = {
                    websiteId: '81b6b08c-b929-4f19-b32f-7213d86139b4',
                    name: name,
                    email: email,
                    subject: subject,
                    message: message,
                ...
                if (result.success) {
                    ...
                    if (result.thankYouPagePath && result.ticketNumber) {
                        ...
                        if (isPreviewMode && window.ZAPPY_CONFIG) {
                            ...
                            const websiteId = window.ZAPPY_CONFIG.websiteId || '81b6b08c-b929-4f19-b32f-7213d86139b4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '81b6b08c-b929-4f19-b32f-7213d86139b4';
